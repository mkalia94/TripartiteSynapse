...
NaCi0,KCi0,ClCi0,CaCi0,GluCi0,Wi0,NaCe0,KCe0,ClCe0,CaCc0,GluCc0,We0,NaCg0,KCg0,ClCg0,CaCg0,GluCg0,Wg0,NaCp0,KCp0,ClCp0,CaCp0,GluCp0,Wp0,CNa,CK,CCl,CCa,CGlu,Vi0,Vg0,Vp0,F,C= symbols("NaCi0,KCi0,ClCi0,CaCi0,GluCi0,Wi0,NaCe0,KCe0,ClCe0,CaCc0,GluCc0,We0,NaCg0,KCg0,ClCg0,CaCg0,GluCg0,Wg0,NaCp0,KCp0,ClCp0,CaCp0,GluCp0,Wp0,CNa,CK,CCl,CCa,CGlu,Vi0,Vg0,Vp0,F,C")

ex1 = -NaCi0 - KCi0 - ClCi0 - CaCi0 - GluCi0 - NAi/Wi0 + NaCe0 + KCe0 + ClCe0 + CaCc0 + GluCc0 + NAe/We0 + NBe/We0
ex2 =-NaCg0 - KCg0 - ClCg0 - CaCg0 - GluCg0 - NAg/Wg0 - NBg/Wg0 + NaCe0 + KCe0 + ClCe0 + CaCc0 + GluCc0 + NAe/We0 + NBe/We0
ex3 = NaCp0 - KCp0 - ClCp0 - CaCp0 - GluCp0 - NAp/Wp0 -NBp/Wp0 + NaCe0 + KCe0 + ClCe0 + CaCc0 + GluCc0 + NAe/We0 + NBe/We0
ex4 = CNa + CK - CCl + 2*CCa - CGlu - NAi - NAe + NBe - NAg + NBg - NAp + NBp
ex5 = (F/ C) * ((NaCi0 + KCi0 - ClCi0 + 2*CaCi0 + GluCi0)*Wi0 - NAi) - Vi0
