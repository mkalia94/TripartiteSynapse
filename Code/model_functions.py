...
def getModelOutputExp():
        ...
        modelOutputNames = {
                ...
                "- Neuron -":{"exp":"","pl":""},
                "[Na"+"\u207a"+"]":{"exp":"NaCi","pl":r"[Na$^+$]$_n$"},
                "[K"+"\u207a"+"]":{"exp":"KCi","pl":r"[K$^+$]$_n$",},
                "[Cl"+"\u207b"+"]":{"exp":"ClCi","pl":r"[Cl$^-$]$_n$",},
                "[Ca"+"\u00b2"+"\u207a"+"]":{"exp":"CaCi","pl":r"[Ca$^{2+}$]$_n$",},
                "[Glu"+"]":{"exp":"GluCi","pl":r"[Glu]$_n$",},
                "- Astrocyte -":{"exp":"","pl":""},
                "[Na"+"\u207a"+"]":{"exp":"NaCg","pl":r"[Na$^+$]$_a$"},
                "[K"+"\u207a"+"]":{"exp":"KCg","pl":r"[K$^+$]$_a$"},
                "[Cl"+"\u207b"+"]":{"exp":"ClCg","pl":r"[Cl$^-$]$_a$"},
                "[Ca"+"\u00b2"+"\u207a"+"]":{"exp":"CaCg","pl":r"[Ca$^{2+}$]$_a$"},
                "[Glu"+"]":{"exp":"GluCg","pl":r"[Glu]$_n$"},
                "- Volumes -":{"exp":"","pl":""},
