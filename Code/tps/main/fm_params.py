...
def parameters(p, dict_):
    ...
    p.NAe = (p.F*p.We0*p.Wi0*(-p.ClCe0 + p.ClCi0 - p.KCe0 + p.KCi0 - p.NaCe0 + p.NaCi0) + p.F*p.Wi0*(2*p.CCa - p.CCl - p.CGlu + p.CK + p.CNa) + p.Wi0*(p.C*p.Vg0 + p.C*p.Vp0 - 2*p.CaCg0*p.F*p.VolPAP - 2*p.CaCp0*p.F*p.VolPostSyn + p.ClCg0*p.F*p.Wg0 + p.ClCp0*p.F*p.Wp0 + p.F*p.GluCg0*p.VolPAP - p.F*p.KCg0*p.Wg0 - p.F*p.KCp0*p.Wp0 - p.F*p.NaCg0*p.Wg0 - p.F*p.NaCp0*p.Wp0) - (p.We0 - p.Wi0)*(p.C*p.Vi0 - 2*p.CaCi0*p.F*p.VolPreSyn + p.ClCi0*p.F*p.Wi0 + p.F*p.GluCi0*p.VolPreSyn - p.F*p.KCi0*p.Wi0 - p.F*p.NaCi0*p.Wi0))/(2*p.F*p.Wi0)
    p.NAi = -p.C*p.Vi0/p.F + 2*p.CaCi0*p.VolPreSyn - p.ClCi0*p.Wi0 - p.GluCi0*p.VolPreSyn + p.KCi0*p.Wi0 + p.NaCi0*p.Wi0
    p.NAp = -p.C*p.Vi0*p.Wp0/(2*p.F*p.Wi0) - p.C*p.Vp0/(2*p.F) + p.CaCi0*p.VolPreSyn*p.Wp0/p.Wi0 + p.CaCp0*p.VolPostSyn - p.ClCp0*p.Wp0 - p.GluCi0*p.VolPreSyn*p.Wp0/(2*p.Wi0) + p.KCi0*p.Wp0 + p.NaCi0*p.Wp0
    p.NAg = -p.C*p.Vg0/(2*p.F) - p.C*p.Vi0*p.Wg0/(2*p.F*p.Wi0) + p.CaCg0*p.VolPAP + p.CaCi0*p.VolPreSyn*p.Wg0/p.Wi0 - p.ClCg0*p.Wg0 - p.GluCg0*p.VolPAP/2 - p.GluCi0*p.VolPreSyn*p.Wg0/(2*p.Wi0) + p.KCi0*p.Wg0 + p.NaCi0*p.Wg0
    p.NBe = (p.F*p.We0*p.Wi0*(-p.ClCe0 + p.ClCi0 - p.KCe0 + p.KCi0 - p.NaCe0 + p.NaCi0) + p.F*p.Wi0*(-2*p.CCa + p.CCl + p.CGlu - p.CK - p.CNa) + p.Wi0*(-p.C*p.Vg0 - p.C*p.Vp0 + 2*p.CaCg0*p.F*p.VolPAP + 2*p.CaCp0*p.F*p.VolPostSyn - p.ClCg0*p.F*p.Wg0 - p.ClCp0*p.F*p.Wp0 - p.F*p.GluCg0*p.VolPAP + p.F*p.KCg0*p.Wg0 + p.F*p.KCp0*p.Wp0 + p.F*p.NaCg0*p.Wg0 + p.F*p.NaCp0*p.Wp0) - (p.We0 + p.Wi0)*(p.C*p.Vi0 - 2*p.CaCi0*p.F*p.VolPreSyn + p.ClCi0*p.F*p.Wi0 + p.F*p.GluCi0*p.VolPreSyn - p.F*p.KCi0*p.Wi0 - p.F*p.NaCi0*p.Wi0))/(2*p.F*p.Wi0)
    p.NBg = p.C*p.Vg0/(2*p.F) - p.C*p.Vi0*p.Wg0/(2*p.F*p.Wi0) -p.CaCg0*p.VolPAP + p.CaCi0*p.VolPreSyn*p.Wg0/p.Wi0 + p.GluCg0*p.VolPAP/2 - p.GluCi0*p.VolPreSyn*p.Wg0/(2*p.Wi0) - p.KCg0*p.Wg0 + p.KCi0*p.Wg0 - p.NaCg0*p.Wg0 + p.NaCi0*p.Wg0
    p.NBp = -p.C*p.Vi0*p.Wp0/(2*p.F*p.Wi0) + p.C*p.Vp0/(2*p.F) + p.CaCi0*p.VolPreSyn*p.Wp0/p.Wi0 - p.CaCp0*p.VolPostSyn - p.GluCi0*p.VolPreSyn*p.Wp0/(2*p.Wi0) + p.KCi0*p.Wp0 - p.KCp0*p.Wp0 + p.NaCi0*p.Wp0 - p.NaCp0*p.Wp0




    
    print(p.NAi, p.NAe, p.NBg, p.NAg, p.NAp, p.NBp,p.NBe)
    ...
    p.IAMPA20 = p.PAMPA2 * p.AMPA2A0 * (p.F ** 2) * (p.Vp0) / (
            p.R * p.T) * ((p.NaCp0 -
    ...
    p.PClLp = (p.F * p.JKClp0 - p.IClGp0) / p.IClLp0  # Estimated Cl leak conducatance in PS
